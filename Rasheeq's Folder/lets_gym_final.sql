...
--
-- Table structure for table `all_payment_type`
--

DROP TABLE IF EXISTS `all_payment_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `all_payment_type` (
...
--
-- Dumping data for table `all_payment_type`
--

LOCK TABLES `all_payment_type` WRITE;
/*!40000 ALTER TABLE `all_payment_type` DISABLE KEYS */;
INSERT INTO `all_payment_type` VALUES (1,'Equiment Rent'),(2,'Membership Fee');
/*!40000 ALTER TABLE `all_payment_type` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `customer_owns_membership` VALUES (1,3,'2017-08-05'),(2,1,'2017-08-12'),(3,5,'2017-08-07');
...
CREATE TABLE `customer_payment` (
  ...
  CONSTRAINT `customer_payment_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`c_id`),
  CONSTRAINT `customer_payment_ibfk_2` FOREIGN KEY (`payment_type`) REFERENCES `all_payment_type` (`pt_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer_payment` VALUES (1,3,'2017-08-07',2,500),(2,1,'2017-08-05',1,2000);
...
-- Dump completed on 2017-08-08 11:33:50
